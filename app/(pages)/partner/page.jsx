...
const page = () => {
  ...
  return (
    ...
    <Header1 />
    <div className="mt-80">
        <h1 className='text-center my-5'>Partner Registriation</h1>
        ...
        <div className="row shadow-2">
              ...
              <div className="row my-3">
                <div className="col-md-6">
                  <div className="form-input spacing">
                    ...
                    <label className="lh-1 text-16 text-light-1">Organization Name</label>
                  </div>
                </div>
                <div className="col-md-6">
                  <div className="form-input spacing">
                ...
                <div className="col-md-6">
                  <div className="form-input spacing">
                    <input type="text" required />
                    <label className="lh-1 text-16 text-light-1">House No</label>
                  </div>
                </div>
                <div className="col-md-6">
                  <div className="form-input spacing">
            ...
            <div className=" y-gap-30 contactForm px-20 py-20 ">
              ...
              <div className="row my-3">
                ...
                <div className="col-md-12">
                  <div className="form-input spacing">
                    ...
                    <span>At least 8 characters include uppercase and lowercase letters, numbers and special characters</span>
                  </div>
                </div>
                <div className="col-md-12">
                  <div className="form-input spacing">
              ...
              <div className="col-12">
                <div className="flex-center">
                  <button className="button -sm -info-2 bg-accent-1 text-white col-lg-3 my-4 col-sm-6 mx-10 mx-md-3">Send</button>
                </div>
              </div>
