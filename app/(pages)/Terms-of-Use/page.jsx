...
const TermsofUse = () => {
  ...
  return (
    ...
    <p className="text-start">(3) Die nachfolgenden Bedingungen gelten ausschließlich für die Vermittlung von Drittanbieterleistungen und sind Bestandteil des zwischen Ihnen und Mekkabooking zustande kommenden Vermittlungsauftrags. Wir weisen Sie ausdrücklich darauf hin, dass ausschließlich der jeweilige Drittanbieter als Reiseveranstalter ihr Vertragspartner der gebuchten Leistungen wird. Mit Mekkabooking kommt kein Vertrag über die Erbringung der Drittanbieterleistungen zustande.</p>

    <p className="text-start">(4) Diese Bedingungen haben keinen Einfluss auf die jeweiligen Geschäftsbedingungen der Drittanbieter, die für die Erbringung der gebuchten Leistungen im Verhältnis zwischen Ihnen und dem Drittanbieter gelten.</p>
    ...
    <p className="text-start">(2) Im Falle der Buchung über unsere Website beauftragen Sie durch Anklicken des „Buchung abschicken“-Buttons im letzten Schritt des Buchungsprozesses Mekkabooking mit der Vermittlung der in der Buchungsübersicht angezeigten Drittanbieterleistungen. Gleichzeitig geben Sie durch Anklicken des „Buchung abschicken“-Buttons gegenüber dem Drittanbieter ein verbindliches Angebot zum Abschluss eines Vertrages über die angezeigten Leistungen ab.</p>

    <p className="text-start">(3) Mekkabooking ist ermächtigt im Namen des jeweiligen Drittanbieters die Annahme des Angebots zu erklären. Ein Vertrag mit dem Drittanbieter kommt zustande, wenn dieser oder Mekkabooking die Buchung der Leistungen durch eine gesonderte E-Mail annimmt oder Ihnen eine Rechnung oder gebuchte Reisedokumente übersendet.</p>

    <p className="text-start">(4) Im Falle von vermittelten Sonder- und Charterflügen gelten die Bedingungen des jeweiligen Drittanbieters. Alle Sonder- und Charterflüge müssen von Ihnen spätestens 48 Stunden vor Abflug bei der jeweiligen Fluggesellschaft oder sonstigen Drittanbietern rückbestätigt werden. Erfolgt diese Rückbestätigung nicht, so besteht kein Anspruch auf Beförderung.</p>

    <p className="text-start">(5) Die Vertragsbestimmungen mit Angaben zu den gebuchten Drittanbieterleistungen werden Ihnen per E-Mail mit Annahme des Vertragsangebotes durch den jeweiligen Drittanbieter oder Mekkabooking bzw. mit der Benachrichtigung hierüber zugesandt. Die Vertragsbestimmungen und Ihre Bestelldaten werden von MEKKABOOKING zur Vertragsabwicklung gespeichert.</p>

    <p className="text-start">(6) Die für den Vertragsschluss zur Verfügung stehende Sprache ist ausschließlich Deutsch.</p>
    ...
    <p className="text-start">(2) Im letzten Schritt öffnet sich eine Übersichtseite, auf der Sie Ihre Angaben überprüfen und gegebenenfalls Ihre Eingabefehler (z.B. bzgl. Bezahlart oder Daten) korrigieren können. Falls Sie den Buchungsprozess komplett abbrechen möchten, können Sie auch einfach Ihr Browser-Fenster schließen. Ansonsten wird nach Anklicken des Bestätigungs-Buttons „Buchung abschicken“ Ihre Erklärung verbindlich iSd § 2 Abs. 2 dieser AGB.</p>
    ...
    <p className="text-start">(2) Gegenstand des mit uns geschlossenen Vermittlungsauftrags ist die Beauftragung von Mekkabooking mit der Vermittlung von Touristikleistungen von Drittanbietern. Die beiderseitigen Rechte und Pflichten von Ihnen und uns ergeben sich, soweit dem nicht zwingende gesetzliche Bestimmungen entgegenstehen, aus den im Einzelfall individuell getroffenen Vereinbarungen, diesen Geschäftsbedingungen und ergänzend den einschlägigen gesetzlichen Vorschriften über den Auftrag gem. §§ 662 ff. BGB.</p>

    <p className="text-start">(3) Für die Rechte und Pflichten des Kunden gegenüber dem jeweiligen Drittanbieter sind allein die mit diesem getroffenen Vereinbarungen, insbesondere die von diesem verwendeten allgemeinen Geschäftsbedingungen maßgeblich.</p>

    <p className="text-start">(4) Sofern der jeweilige Drittanbieter allgemeine Geschäftsbedingungen verwendet, werden Ihnen diese vor der Buchung von uns zur Verfügung gestellt. Für den Inhalt dieser Geschäftsbedingungen sind ausschließlich die jeweiligen Drittanbieter verantwortlich. Im Falle der Buchung von Beförderungsleistungen gelten vorbehaltlich besonderer Vereinbarungen die auf gesetzlicher Grundlage von der zuständigen Verkehrsbehörde oder die aufgrund internationaler Übereinkommen erlassenen Beförderungsbedingungen und Tarifbestimmungen.</p>

    <p className="text-start">(5) Eine Buchung von durch Mekkabooking vermittelten Touristikleistungen ist erst ab Erlangung der vollen Geschäftsfähigkeit möglich.</p>

    <p className="text-start">(6) Informationen über Touristikleistungen und Drittanbieter basieren auf den Informationen, die wir von den jeweiligen Drittanbietern erhalten. Für die Vollständigkeit, Richtigkeit und Aktualität der Informationen ist der jeweilige Drittanbieter verantwortlich. Dies gilt nicht für falsche Informationen, die durch einen technischen Fehler unseres Buchungssystems entstehen, es sei denn, wir haben den technischen Fehler nicht zu vertreten.</p>
    ...
    <p className="text-start">(2) Soweit die Reiseunterlagen Ihnen nicht direkt vom Drittanbieter übermittelt werden, erfolgt die Übermittlung durch Mekkabooking elektronischen Versand, sofern Sie keinen Anspruch auf eine Reisebestätigung in Papierform gemäß Art. 250 § 6 Abs. 1 Satz 2 EGBGB haben.</p>

    <p className="text-start">(3) Im Falle der Buchung einer Pauschalreise gem. §§ 651a ff. BGB sind Sie gleichermaßen verpflichtet, Vertrags- und sonstige Unterlagen des Drittanbieters über die Pauschalreise, die Ihnen von uns übermittelt wurden, insbesondere Buchungsbestätigungen, Flugscheine, Hotelgutscheine, Versicherungsscheine und sonstige Unterlagen auf Richtigkeit und Vollständigkeit, insbesondere auf die Übereinstimmung mit der Buchung und dem Vermittlungsauftrag zu überprüfen. Eine Pauschalreise ist eine Gesamtheit von mindestens zwei verschiedenen Arten von Reiseleistungen für den Zweck derselben Reise (§ 651a Abs.1 BGB).</p>

    <p className="text-start">(4) Wir weisen darauf hin, dass Fluggesellschaften statt eines Tickets in Papierform ein elektronisches Ticket (E-Ticket) anbieten. Dabei wird im Regelfall ein elektronischer Buchungscode in Textform (zumeist per E-Mail) übermittelt, der von Ihnen beim Check-In in Verbindung mit einem Identifikationsdokument (Personalausweis bzw. Reisepass) zu nennen oder vorzulegen ist. Bitte informieren Sie sich hierzu vor Reiseantritt bei der betreffenden Fluggesellschaft.</p>

    <p className="text-start">(5) Entsprechend der EU-Verordnung Nr. 2111/2005 über die Erstellung einer gemeinschaftlichen Liste der Luftfahrtunternehmen ist Mekkabooking im Falle der Vermittlung von Flugbeförderungsleistungen verpflichtet, Ihnen bei der Buchung über die Identität der ausführenden Fluggesellschaft zu unterrichten. Sofern bei der Buchung die ausführende Fluggesellschaft noch nicht feststeht, wird Mekkabooking Ihnen die vom Drittanbieter vorliegenden Informationen über diejenige Fluggesellschaft übermitteln, die wahrscheinlich den Flug durchführt. Bei einem Wechsel der Fluggesellschaft werden Sie unverzüglich über den Wechsel unterrichtet. Die gemeinschaftliche Liste über die mit Flugverbot in der Europäischen Union belegten Fluggesellschaften ist über die Internetseiten <Link href='https://transport.ec.europa.eu/index_en'>http://ec.europa.eu/transport/modes/air/safety/air-ban/index_de.htm</Link> abrufbar.</p>
