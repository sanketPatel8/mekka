...
export default function MainInformation({ PAckageData }) {
  ...
  const ratingCountStr = InformationData?.Tour_Details?.tour_details?.rating_count?.toString();

console.log(ratingCountStr); // This will print the rating count as a string
      ...
      <div className="row y-gap-20 justify-between items-end">
        <div className="col-auto">
          ...
          <div className="row x-gap-20 y-gap-20 items-center pt-20">
            ...
            <div className={`col-auto ${!InformationData?.Tour_Details?.tour_details?.distance_to_hotel ? 'd-none' : 'd-block'}`}>
              <div className="d-flex items-center">
